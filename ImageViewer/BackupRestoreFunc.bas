...
'Written By : Tertius Klopper
'Created the module from diffrent code samples found on
'planet-source-code.com
'
'
'Modal Function : Backup and Restore Functions
...
frmBackupDba.lblStatus = "Backup Started"
DoEvents
...
Dim strDestinationDir As String
DB.Close
frmRestoreDba.lblStatus = "Restore Started"
DoEvents
Screen.MousePointer = vbHourglass
BackupFolderName = strDestinationPath
Debug.Print BackupFolderName
...
With SHFileOp
    .wFunc = lFileOp
    .pFrom = strSourcePath & "\ImageDBA.MDB" & vbNullChar
    Debug.Print .pFrom
...
Public Function FileEx(fPath As String) As Boolean
Dim fs As Object
Set fs = CreateObject("Scripting.filesystemobject")
FileEx = fs.fileexists(fPath)
End Function
